...
<?php else : ?>
	...
	<div>
		...
		if($used_datapoints>=$maximumDatapoints)
			echo '<span>Available datapoints: </span><span id="red_events"><strong>0</strong><span style="padding-left:20px">You exceeded the allowed number of datapoints.</span></span><br>';
		else {
